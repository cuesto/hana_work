/*global history */
sap.ui.define([
	"sales/controller/BaseController",
	...
	return BaseController.extend("sales.controller.Master", {
		...
		onGroup: function(oEvent) {
			...
			if (sKey === "DocTotal") {
				...
				this.getModel("masterView").setProperty("/sortBy", "DocTotal");

				aSorters.push(
					new Sorter("DocTotal", false,
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("sales.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "Filter1":
						aFilters.push(new Filter("DocTotal", FilterOperator.LE, 100));
						break;
					case "Filter2":
						aFilters.push(new Filter("DocTotal", FilterOperator.GT, 100));
						break;
					default:
						break;
				}
