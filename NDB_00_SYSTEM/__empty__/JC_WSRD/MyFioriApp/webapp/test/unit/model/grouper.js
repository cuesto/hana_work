sap.ui.define([
	...
	QUnit.module("Grouping functions", {
		setup: function() {
			this._oResourceModel = new ResourceModel({
				bundleUrl: [$.sap.getModulePath("sales"), "i18n/i18n.properties"].join("/")
			});
		},
		teardown: function() {
	...
	QUnit.test("Should group the price", function(assert) {
		...
		// Assert
		oGrouperReturn = grouper.DocTotal.bind(oControlStub)(oContextObjectLower);
		...
		oGrouperReturn = grouper.DocTotal.bind(oControlStub)(oContextObjectHigher);
