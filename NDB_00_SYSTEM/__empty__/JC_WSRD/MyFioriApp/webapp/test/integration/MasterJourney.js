sap.ui.define([], function() {
	...
	opaTest("MasterList Filtering on DocTotal less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("DocTotal").
		and.iSelectListItemInViewSettingsDialog("<100 DocCur").
	...
	opaTest("MasterList Filtering on DocTotal more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 DocCur").
		and.iPressOKInViewSelectionDialog();
