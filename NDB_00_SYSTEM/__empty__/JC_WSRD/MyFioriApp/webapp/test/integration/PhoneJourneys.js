...
jQuery.sap.require("sales.test.integration.NavigationJourneyPhone");
jQuery.sap.require("sales.test.integration.NotFoundJourneyPhone");
jQuery.sap.require("sales.test.integration.BusyJourneyPhone");