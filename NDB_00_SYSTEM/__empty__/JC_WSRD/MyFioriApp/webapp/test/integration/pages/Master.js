						...
						success: function(aEntityData) {
							this.waitFor({
								...
								success: function(oList) {
									...
									this.getContext().currentId = aItemsNotInTheList[0].DocEntry;
								},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						success: function() {
							QUnit.ok(true, "The list header displays 'doc (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function() {
					return this.theListShouldBeSortedAscendingOnField("DocTotal");
				},
