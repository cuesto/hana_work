sap.ui.define([], function() {
	...
	return {
		...
		/**
		 * Grouping function to group the master list by DocTotal
		 * @public
		 * @param {object} oContext the current list item context
		 * @returns {object} an object with the DocTotal as key and a text for the group headers
		 */
		DocTotal: function(oContext) {
			var iPrice = oContext.getProperty("DocTotal"),
				sKey,
				sText,
