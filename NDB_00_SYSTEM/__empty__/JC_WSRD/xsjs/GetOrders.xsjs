$.import("JC_WSRD.ServiceLayer","B1SLLogic"); 
...
function GetOrders(appRequest){
    ...
    // SL LOGIN          
    var response = $.JC_WSRD.ServiceLayer.B1SLLogic.SLLogin(JSON.stringify(loginInfo), null, null);
    ...
    response = $.JC_WSRD.ServiceLayer.B1SLLogic.GetOrders(appRequest, SESSIONID,NODEID);
